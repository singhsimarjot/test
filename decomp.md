...
// Bind the function with this statement
// Using Arrow Function
// By adding event listener 


// Buttons
// Button1: Nothing will happen on Button one click because it will called onload
// Button2: it will trow error for name undefined
// Button3 : It will show the name because its bind in constructor and get the value on name
// Button4 : It will also show the name because it bind to the class
